 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8282/TestCoupa/SoapService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://service/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8282/TestCoupa/SoapService?WSDL");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://service/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "SoapServicePort"), SoapService.class, features);
    }
